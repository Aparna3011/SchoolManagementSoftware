...
contextBridge.exposeInMainWorld("api", {
  ...
  student: {
    ...
    getEnrollments: (studentId) =>
      ipcRenderer.invoke("student:getEnrollments", studentId),
    getFeesSummaryByYear: (studentId) =>
      ipcRenderer.invoke("student:getFeesSummaryByYear", studentId),
    ...
    updateStatus: (id, status) =>
      ipcRenderer.invoke("student:updateStatus", { id, status }),
    ...
    deletePhoto: (photoPath) =>
      ipcRenderer.invoke("student:deletePhoto", photoPath),
    printPdf: (base64Pdf) =>
